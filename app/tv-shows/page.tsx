...
import logo from "@/public/assets/images/tv-shows/showLogo.svg"
...
<section
  ...
  style={{
    backgroundImage: "url('/assets/images/tv-shows/tvshowsBack.svg')",
  }}
>
  {/* Bottom fade overlay */}
  <div
  ...
  />
       ...
       <div className="relative pt-[13rem] ml-[1.5rem] z-10 flex flex-col h-full text-center text-white px-4 items-center lg:items-start">
            <Image src={logo} width={220} height={197} alt='tvlogo'/>
