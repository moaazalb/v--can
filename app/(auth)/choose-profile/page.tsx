...
export default function ProfileSelectionPage() {
  return (
    <Box
      sx={{
        minHeight: '100vh',
        backgroundImage: 'url(/assets/images/Background.png)', // <-- Background Image here
    ...
    >
        <Typography variant="h5" sx={{ color: 'hsla(0, 0%, 100%, 1)', mb: 4,fontStyle:"Bold",  fontFamily: 'Cairo, sans-serif',fontSize:32, fontWeight:700 }}>
          Select a profile
        </Typography>
...
>
        ...
        <Typography
          variant="body2"
          sx={{ color: 'rgba(255,255,255,0.6)', mt: 6, cursor: 'pointer', fontFamily: 'Cairo, sans-serif',fontSize:20, fontWeight:500, fontStyle:"SemiBold", }}
        >
          Back to login?
        </Typography>
        </Box>
