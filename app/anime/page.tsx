...
import logo from "@/public/assets/images/anime/showLogo.svg"
...
<section
  ...
  style={{
    backgroundImage: "url('/assets/images/anime/animeBack.svg')",
  }}
>
  {/* Bottom fade overlay */}
  <div
  ...
  />
       ...
       <div className="relative pt-[13rem] ml-[1.5rem] z-10 flex flex-col h-full text-center text-white px-4 items-center lg:items-start">
            <Image src={logo} width={408} height={123} alt='logo'/>
