...
import logo from "@/public/assets/images/moviesPage/showLogo.svg"
...
<section
  ...
  style={{
    backgroundImage: "url('/assets/images/moviesPage/moviesBack.svg')",
  }}
>
  {/* Bottom fade overlay */}
  <div
  ...
  />
       ...
       <div className="relative pt-[13rem] ml-[1.5rem] justify-center z-10 flex flex-col h-full text-center text-white px-4 items-center lg:items-start">
            <Image src={logo} width={160} height={260} alt='logo'/>
